    ...
    <div className="bg-[#f3efe9] text-gray-800">
      ...
      <section className="w-full bg-[#f3efe9]">
        <div className="relative w-full h-[420px] sm:h-[480px] lg:h-[520px] overflow-hidden">
          <img
            src={tenant}
            alt="Landlord Support & Investment Advisory"
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center h-full px-4">
            ...
            >
              Expert guidance and professional support for landlords and
              property investors to maximize returns and manage their real
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div data-aos="fade-left" className="max-w-[520px]">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif leading-tight mb-6">
              Strategic Guidance <br /> For Landlords & Investors
            </h2>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4">
              Managing rental properties and real estate investments can be
              complex. Our landlord support and investment advisory services
              provide expert guidance to help property owners make informed
              decisions while protecting and growing their investments.
            </p>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              From investment strategy and market insights to property
              performance optimization, we support landlords with professional
              advice designed to maximize long-term value and returns.
            </p>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: "Analyzing your current property portfolio and investment goals.",
              },
              {
                title: "Market Insights",
                desc: "Providing up-to-date market data and property investment trends.",
              },
              {
                title: "Strategy Planning",
                desc: "Creating tailored strategies to improve property performance.",
              },
              {
                title: "Ongoing Guidance",
                desc: "Continuous support and advice for long-term investment success.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="relative z-10 max-w-[1100px] mx-auto w-full px-4 sm:px-6">
          ...
          <div className="max-w-[520px] mx-auto space-y-6">
            {[
              ...
              "Improved Property Portfolio Performance",
      ...
      <section className="bg-[#f3efe9] py-20 sm:py-24 lg:py-32">
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 text-center">
          ...
          >
            Ready to Grow Your Property Investment?
          </h2>
